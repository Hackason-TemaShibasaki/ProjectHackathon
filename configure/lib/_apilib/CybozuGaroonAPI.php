...
try {
    ...
    echo $ex->getMessage();
        ...
        protected function decodeString($arg) {
            if ($this->is_convet_string || !defined("__PHP_HAS_MBSTRING__")) {
                ;   // already converted
            } else {
...
$headers[] = new SoapHeader("http://wsdl.cybozu.co.jp/util_api/2008", "Action", new SoapVar($work_str, XSD_ANYXML));
...
$headers[] = new SoapHeader("http://wsdl.cybozu.co.jp/util_api/2008", "Security", new SoapVar($work_str, XSD_ANYXML));
            }
...
$headers[] = new SoapHeader("http://wsdl.cybozu.co.jp/util_api/2008", "Timestamp", new SoapVar($work_str, XSD_ANYXML));
...
$headers[] = new SoapHeader("http://wsdl.cybozu.co.jp/util_api/2008", "Locale", new SoapVar($work_str, XSD_ANYXML));
            // set Soap Header
