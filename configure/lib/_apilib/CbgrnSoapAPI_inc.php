...
//----------------------------------------------------------------------
define('CBGRNAPI_SERVER_NAME', 'cyb-grn.alphawave.co.jp');    // Cybozu Garoon Server FQDN.
...
define('CBGRNAPI_SERVER_IS_APACHE', true);                     // if Cybozu Garoon Server is Windows
                                                               ...
                                                               //            is IIS    : false
define('CBGRNAPI_IDENTIFIER', 'grn210');                // Cybozu Garoon install identifier. default as 'cbgrn'
//-----------------------------------------------------------------------
